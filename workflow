...
Optiamo per realizzare una lista di hash tables. Sia nelle slides che nei progetti degli altri vediamo che è questa la struttura dati scelta. Non vediamo perché fare una cosa diversa.
...
Inizializziamo il Group ID del file POM ed aggiungiamo le dependencies dei pacchetti antlr. 
